 ...
 *Cota ->
 */
public class BranchBoundEager2{
    ...
    public BranchBoundEager2(double[][] mDistancies, int[][] mDisponibilitats, int[][] mNecessitats, String[] mPlanetes, String[] mRecursos){
