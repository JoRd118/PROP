...
public class Driver_Controlador_Domini_Planeta{
	...
	public static void menu() {
        ...
        System.out.println("\t 02) public Controlador_Domini_Planeta(Controlador_Domini_Paquet p, Controlador_Domini_Recurs r).");
        System.out.println("\t 03) public void altaPlaneta(String nom, Coordenades coord, boolean classeM).");
        System.out.println("\t 04) public void baixaPlaneta(String nom).");
        System.out.println("\t 05) public Planeta assignarPlaneta(String nomP).");
        System.out.println("\t 06) public void desassignarPlaneta(String nomP).");
        System.out.println("\t 07) public void modificarNom(String nom, String newnom).");
        System.out.println("\t 08) public void modificarCoordenades(String nom, int x, int y).");
        System.out.println("\t 09) public void modificarClasse(String nom, boolean classeM).");
        System.out.println("\t 10) public void baixaPlaneta(String nom).");
        System.out.println("\t 11) public int obtenirId(String nom).");
        System.out.println("\t 12) public boolean obtenirClasse(String nom).");
        System.out.println("\t 13) public Coordenades obtenirCoordenades(String nom).");
        System.out.println("\t 14) public Planeta obtenirPlaneta(String nom).");
        System.out.println("\t 15) public String llistarPlanetesDesassignat().");
        System.out.println("\t 16) public String llistarPlanetesAssignat().");
        System.out.println("\t 17) public void altaNecessitats(String nomP, String nomR).");
        System.out.println("\t 18) public void baixaNecessitats(String nomP, String nomR).");
        System.out.println("\t 19) public void assignarPaquet(String nomP, int id).");
        System.out.println("\t 20) public Iterable<String> obtenirRecursosDisponibles(String nomP).");
        System.out.println("\t 21) public Iterable<String> obtenirNecessitats(String nomP).");
        System.out.println("\t 22) public void guardarPlanetes(String nomFitxer).");
