...
public class Driver_Controlador_Domini_QAP{
    ...
    public static void menu() {
        ...
        //---QAP---
        System.out.println("\t 100) public Controlador_Domini_QAP(Entrada e).");
        System.out.println("\t 101) public void calcularMatrius(String nom_u).");
        System.out.println("\t 102) public void run_algorithm(String algorithm).");
        System.out.println("\t 103) public String printSolucioQAP().");
        System.out.println("\t 104) public void guardar_solucioQAP(String nomFitxer).");
            ...
            try{
                ...
                switch (op) {
                    ...
                    case "102":
                        ...
                        break;
                    case "103":
                        System.out.println(t.printSolucioQAP());
                        break;
                    case "104":
                        nom = scan.nextLine();
