...
public class Driver_QAP{
    ...
    public static void menu() {
        ...
        System.out.println("\t 102) public void afegirSolucioQAP(SolucioQAP s).");
        System.out.println("\t 103) public void afegirTemps(double tem).");
        System.out.println("\t 104) public double obtenirTemps().");
        ...
        System.out.println("\t 204) public double obtenirPosDis(int i, int j).");
        System.out.println("\t 205) public int obtenirPosNecPlaneta(int i, int j).");
        System.out.println("\t 206) public int obtenirPosRecPlaneta(int i, int j).");
        System.out.println("\t 207) public String obtenirPosRecu(int i).");
        System.out.println("\t 208) public String obtenirPosPlan(int i).");
        System.out.println("\t 209) public void modificarPosDis(int i, int j, double valor).");
        System.out.println("\t 210) public void modificarPosNecPlaneta(int i, int j, int valor)");
        System.out.println("\t 211) public void modificarPosRecPlaneta(int i, int j, int valor).");
        System.out.println("\t 212) public void modificarPosRecu(int i, String valor).");
        System.out.println("\t 213) public void modificarPosPlan(int i, String valor).");
        System.out.println("\t 214) public double[][] obtenirMatriuDisPla().");
        System.out.println("\t 215) public int[][] obtenirMatriuNecPla().");
        System.out.println("\t 216) public int[][] obtenirMatriuRecPla().");
        System.out.println("\t 217) public String[] obtenirVectorRecu().");
        System.out.println("\t 218) public String[] obtenirVectorPlan().");
        System.out.println("\t 219) public String obtenirMatriuDisString().");
        System.out.println("\t 220) public String obtenirMatriuNecString().");
        System.out.println("\t 221) public String obtenirMatriuRecString().");
        System.out.println("\t 222) public void modificarMatriusString(String dist, String nec, String rec, String p, String r).");
        ...
        while(!out){
            try{
                ...
                switch (op) {
                    ...
                    case "102":
                        SolucioQAP aux1 = new SolucioQAP();
                        s.afegirSolucioQAP(aux1);
                        break;
                        
                    case "103":
                        lo = Long.parseLong(scan.nextLine());
                        s.afegirTemps(lo);
                        break;
