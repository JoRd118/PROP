...
public class Driver_Controlador_Domini_Paquet {
	...
	public static void menu() {
        ...
        System.out.println("\t 17) public void borrar_recurs3(String nom).");
        System.out.println("\t 18) public void modificar_nom_recurs3(String old_name, String new_name).");
		...
		while(!out){
            try{
                ...
                switch (op) {
                    ...
                    case "15":
                        num = scan.nextLine();
                        Iterable<String> s = p.llistatRecursosPaquetIterator(Integer.parseInt(num));
                    ...
                    case "17":
                        nom = scan.nextLine();
                        p.borrar_recurs3(nom);
                        break;

                    case "18":
                        p.modificar_nom_recurs3(scan.nextLine(),scan.nextLine());
                        break;
